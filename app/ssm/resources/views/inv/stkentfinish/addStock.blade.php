                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="refInvoiceNo">Ref Invoice No:</label>
                                        <input type="text" id="refInvoiceNo" name="refInvoiceNo" class="form-control" maxlength="35" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                     <div class="form-group" >
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="totalCgst" name="totalCgst" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="totalSgst" name="totalSgst" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="mode" name="mode" class="form-control" maxlength="30">
                                    </div>
                                </div>
